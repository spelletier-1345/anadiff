...
# source("./Scripts/array/array_sources.R") # TODO : delete
...
AnaDiff_Agilent <- function(
  ...
  popBH="alternate",
  statBH="BH",
  dataTest=conf$dataTest,
  bkgCalculation = TRUE,
  dec = "."
  ) {
  # Author: Sandra Pelletier IRHS-BIDeFI
  # @Param: 
  ...
  # # - labelling
  # cat("\n");cat(">>> array_data.R\n")
  # source("./Scripts/array/array_data.R", TRUE)
  # 
  # # Analyse des données
  # #####################
  # 
  ...
  #   # sw <- data$swaps[1]
  #   cat("\n");cat(">>> array_swap.R\n")
  #   source("./Scripts/array/array_swap.R", TRUE)
  #   if (conf$graph) {
  #     cat("\n");cat(">>> array_graph-GEO.R\n")
  #     source("./Scripts/array/array_graph-GEO.R")
  #   }
  #   
  #   # export
  ...
  #     # ex <- data$exports[1]
  #     cat("\n");cat(">>> array_export.R\n")
  #     source("./Scripts/array/array_export.R", TRUE)
  #     
  #     # sens
  #     for (se in c("sens", "antisens")) {
  #       # se <- "sens"
  #       cat("\n");cat(">>> array_sens.R\n")
  #       source("./Scripts/array/array_sens.R", TRUE)
  #       cat("\n");cat(">>> array_stats.R\n")
  #       source("./Scripts/array/array_stats.R", TRUE)
  #       if (conf$db) {
  #         cat("\n");cat(">>> array_json4db.R\n")
  #         source("./Scripts/array/array_json4db.R")
  #       }
  #       # cat("\n");cat(">>> array_alerte.R\n")
  #       # source("./Scripts/array/array_alerte.R")
  #     }
  #     cat("\n");cat(">>> array_exceptions.R\n")
  #     source("./Scripts/array/array_exceptions.R")
  #     cat("\n");cat(">>> array_tableDoubleSAS.R\n")
  #     source("./Scripts/array/array_tableDoubleSAS.R", TRUE)
  #   }
  #   cat("\n");cat(">>> array_alerte-req.R\n")
  #   source("./Scripts/array/array_alerte-req.R", TRUE)
  # }
  # cat("\n===================================\n")
