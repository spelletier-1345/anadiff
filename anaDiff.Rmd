...
Ce script est utilisé par un exécutable `Rmd_to_html`
...
## Automatisation de la conversion du .Rmd en .html
L'automatisation de la conversion d'un document .Rmd en .html peut se faire en ligne de commande 
## Mémo
